...
import com.eventhub.tickets.domain.enums.TicketValidationStatusEnum;
...
import com.eventhub.tickets.repository.TicketValidationRepository;
...
public class TicketValidationServiceImpl implements TicketValidationService {
    ...
    private TicketValidation validateTicket(Ticket ticket,
                                            TicketValidationMethodEnum qrScan) {
        TicketValidation ticketValidation = new TicketValidation();
        ticketValidation.setValidationMethodEnum(qrScan);
